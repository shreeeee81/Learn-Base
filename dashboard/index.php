...
<h3 class="page-header">
                            <center> <marquee width = 70% ><font color="green" > Courses uploaded by various users</font></marquee></center>
                        </h3>
<div class="row">
<div class="col-lg-12">
...
<?php 
 ...
 <h3 class="page-header">
                            <center> <marquee width = 70% ><font color="green" ><?php echo $_SESSION['course']; ?> Engineering </font><font color="brown"> Courses uploaded by various users</font></marquee></center>
                        </h3>
