 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index">Learn Base</a>
            </div>
...
<div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php if($_SESSION['role'] == 'admin') {
                   ...
                   <li>
                    ...
                    <li>
                         <a href="javascript:;" data-toggle="collapse" data-target="#user"><i class="fa fa-fw fa-users"></i> My Course <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="user" class="collapse">
                            <li>
                                <a href="./notes.php">View All Course</a>
                            </li>
                            <li>
                                <a href="./uploadnote.php">Upload Course</a>
                            </li>
